...
import 'package:food_store/views/navController/pages/account.dart';
import 'package:food_store/views/navController/pages/history.dart';
import 'package:food_store/views/navController/pages/home.dart';
import 'package:get/get.dart';

class BottomNavController extends StatelessWidget {
  RxInt _currentIndex = 0.obs;
  final _pages = [Home_Screen(), History_Screen(), Account_Screen()];
  @override
